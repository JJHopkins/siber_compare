...
x_x,y_x_unsc = np.loadtxt('data/CG10e2x.csv',delimiter=',',unpack=True, usecols = [0,1])
x_y,y_y_unsc = np.loadtxt('data/CG10e2y.csv',delimiter=',',unpack=True, usecols = [0,1])
x_z,y_z_unsc = np.loadtxt('data/CG10e2z.csv',delimiter=',',unpack=True, usecols = [0,1])
...
pl.ylabel(r'$\varepsilon^{\prime\prime}(\omega)$', size = 24)
pl.legend()
pl.title(r'CG-10 DNA and water eps2')
pl.show()
#pl.close()
#imshow(1)
#pl.savefig('plots/131010_Hopkins_CG10_eps2_x_z.png', dpi = 300 )
