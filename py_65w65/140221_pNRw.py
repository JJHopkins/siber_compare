...
pl.savefig('plots/par_NR_water/140306_65w65_Nonret_skew_g_vs_l.pdf')
pl.show()
...
pl.axis([1.0e-9, 1.0e-6,1.0e-17,1.0e1])
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/par_NR_water/140306_65w65_Compare_par_normalized_g_vs_l.pdf')
pl.show()
