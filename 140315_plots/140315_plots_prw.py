...
pl.loglog((1e9)*x_091_par, (1e21)*y_091_par,'g-', label = '[ 9,1]')#A_py_par)
pl.loglog((1e9)*x_093_par, (1e21)*y_093_par,'r-', label = '[ 9,3]')#A_py_par)
pl.loglog((1e9)*x_290_par, (1e21)*y_290_par,'c-', label = '[29,0]')#A_py_par)
...
#--- 65w65 ------------------------------------------------------------------
pl.figure()
pl.loglog((1e9)*x_065_par, abs((1e21)*y_065_par - (1e21)*y_065_par[0]),'b-', label = '[ 6,5]')#A_py_par)
pl.loglog((1e9)*x_091_par, abs((1e21)*y_091_par - (1e21)*y_091_par[0]),'g-', label = '[ 9,1]')#A_py_par)
pl.loglog((1e9)*x_093_par, abs((1e21)*y_093_par - (1e21)*y_093_par[0]),'r-', label = '[ 9,3]')#A_py_par)
pl.loglog((1e9)*x_290_par, abs((1e21)*y_290_par - (1e21)*y_290_par[0]),'c-', label = '[29,0]')#A_py_par)
#pl.loglog(x90_A0, y90_A0,'k-' , label = r'GH $\mathcal{A^{(0)}}(\ell)$')
#pl.loglog(x90_A2, y90_A2,'k--', label = r'GH $\mathcal{A^{(2)}}(\ell)$')
pl.xlabel(x_ax)
pl.ylabel(y_ax_par)
...
plsvfig(x_065_par, y_065_par, A_py_par, A_GH_par, x_ax, y_ax_par, title('6' ,'5','parallel'), svfig('6','5','parallel'))
#plsvfig(x_090_par, y_090_par, A_py_par, A_GH_par, x_ax, y_ax_par, title('9' ,'0','parallel'), svfig('9','0','parallel'))
plsvfig(x_091_par, y_091_par, A_py_par, A_GH_par, x_ax, y_ax_par, title('9' ,'1','parallel'), svfig('9','1','parallel'))
plsvfig(x_093_par, y_093_par, A_py_par, A_GH_par, x_ax, y_ax_par, title('9' ,'3','parallel'), svfig('9','3','parallel'))
plsvfig(x_290_par, y_290_par, A_py_par, A_GH_par, x_ax, y_ax_par, title('29','0','parallel'), svfig('29','0','parallel'))
