...
gh_len0, gh_A0 = np.loadtxt('data/93-w-93-500nmA0.txt',unpack=True, usecols = [0,1]) # water as intervening medium
gh_len2, gh_A2 = np.loadtxt('data/93-w-93-500nmA2.txt',unpack=True, usecols = [0,1]) # water as intervening medium
...
#pl.axis([0,500,0.9,2.6])
pl.grid()
pl.savefig('plots/skew_ret_water/140306_93w93_aiz.pdf' )
show()
...
pl.savefig('plots/skew_ret_water/140306_93w93_GH_skew_ret_A0_A2.pdf')
show()
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/skew_ret_water/140306_93w93_skew_ret_A0_A2.pdf')
show()
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/skew_ret_water/140306_93w93_skew_ret_G_vs_l.pdf')
show()
