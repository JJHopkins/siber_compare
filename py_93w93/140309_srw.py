...
x90_A0, y90_A0 = np.loadtxt('data/93-W-93-PERPA0.PRN',unpack=True, usecols = [0,1]) # water as intervening medium
x90_A2, y90_A2 = np.loadtxt('data/93-W-93-PERPA2.PRN',unpack=True, usecols = [0,1]) # water as intervening medium
...
pl.savefig('plots/skew_ret_water/140309_93w93_GH_skew_ret_A0_A2.pdf')
show()
