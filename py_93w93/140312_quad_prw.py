...
def inner_integral(N, h , a, eizw, L):
	...
	"""
	return integrate.quad(integrand, 0, np.inf, args=(N,h, a,eizw,L))[0]
...
for j,length in enumerate(ls):
	...
	for k,n in enumerate(ns):
		...
		I = integrate.quad(lambda h: inner_integral(n,h,aiz[k],eiz_w[k],length), 1.1, np.inf)
		print I[0] 
		
		# Im not sure how to plug I into A for each pair of j,k values. I'd like to  be able 
		# be able to put I[j,k] in the arg of As here:
