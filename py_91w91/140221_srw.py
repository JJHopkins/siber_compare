...
gh_len0, gh_A0 = np.loadtxt('data/91-w-91-500nmA0.txt',unpack=True, usecols = [0,1]) # water as intervening medium
gh_len2, gh_A2 = np.loadtxt('data/91-w-91-500nmA2.txt',unpack=True, usecols = [0,1]) # water as intervening medium
...
#pl.axis([0,500,0.9,2.6])
pl.grid()
pl.savefig('plots/skew_ret_water/140306_91w91_aiz.pdf' )
show()
...
pl.loglog(gh_len0, gh_A0,'k-' , label = r'$\mathcal{GH\,A^{(0)}}(\ell)$')
pl.loglog(gh_len2, gh_A2,'k--', label = r'$\mathcal{GH\,A^{(2)}}(\ell)$')

pl.xlabel(r'$\mathrm{separation}\,\ell\,\,\,\rm{[nm]}$', size = 20)
pl.ylabel(r'$\mathrm{\mathcal{A^{(0)},\,\,A^{(2)}}\,\,\,[zJ]}$', size = 20)
...
pl.savefig('plots/skew_ret_water/140306_91w91_GH_skew_ret_A0_A2.pdf')
show()
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/skew_ret_water/140306_91w91_skew_ret_A0_A2.pdf')
show()
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/skew_ret_water/140306_91w91_skew_ret_G_vs_l.pdf')
show()
