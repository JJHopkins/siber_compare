...
x_x,y_x_unsc = np.loadtxt('data/CNT9_1_xe2_solid_30.txt',unpack=True, usecols = [0,1])
x_z,y_z_unsc = np.loadtxt('data/CNT9_1_ze2_solid_30.txt',unpack=True, usecols = [0,1])
...
pl.ylabel(r'$\varepsilon^{\prime\prime}(\omega)$', size = 24)
pl.legend()
pl.title(r'[9,1] and water eps2')
pl.savefig('plots/140306_91w91_eps2.pdf')
pl.show()
#pl.close()
#imshow(1)
#pl.savefig('plots/131010_Hopkins_CG10_eps2_x_z.png', dpi = 300 )
...
pl.legend()
pl.title(r'[9,1] and water eiz')
#pl.savefig('plots/DNA_eiz_x_z.png', dpi = 300 )
pl.savefig('plots/140306_91w91_eiz.pdf')
pl.show()
#pl.close()
