...
x_x,y_x_unsc = np.loadtxt('data/CNT9_0_xe2_solid_30.txt',unpack=True, usecols = [0,1])
x_z,y_z_unsc = np.loadtxt('data/CNT9_0_ze2_solid_30.txt',unpack=True, usecols = [0,1])
...
pl.savefig('plots/90w90_eiz.pdf')
pl.show()
