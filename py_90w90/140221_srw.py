...
x90_A0, y90_A0 = np.loadtxt('data/91-W-91-PERPA0.PRN',unpack=True, usecols = [0,1]) # water as intervening medium
x90_A2, y90_A2 = np.loadtxt('data/91-W-91-PERPA2.PRN',unpack=True, usecols = [0,1]) # water as intervening medium
...
pl.savefig('plots/skew_ret_water/140309_91w91_GH_skew_ret_A0_A2.pdf')
show()
