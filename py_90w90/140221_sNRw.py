...
pl.loglog(ls[0],G_l_t_dt[0,0],' ', label = r'$\mathcal{A}_{term\,1} = %3.2f$'%(1.0e21*(kb*T/32)*sum_A))
pl.loglog(ls[0],G_l_t_dt[0,0],' ', label = r'$\mathcal{A}_{term\,2} = %3.2f$'%(1.0e21*(kb*T/32)*sum_A_2))
...
pl.grid(which = 'both')
pl.tick_params(which = 'both',labelright = True)
pl.savefig('plots/skew_NR_water/140306_91w91_Nonret_skew_G_vs_l.pdf')
show()
...
pl.savefig('plots/skew_NR_water/140306_91w91_Compare_normalized_G_vs_l_perp.pdf')
show()
